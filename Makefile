...
MAN3EXT = 3pm
INSTALLDIRS = site
INSTALL_BASE = /home/amiri/Automation/Catalyst-Helper-Controller-DBIC-API-REST-0.01
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
MAKE = make
FULLEXT = Catalyst/Helper/Controller/DBIC/API/REST
BASEEXT = REST
PARENT_NAME = Catalyst::Helper::Controller::DBIC::API
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
LDFROM = $(OBJECT)
...
INST_LIBDIR      = $(INST_LIB)/Catalyst/Helper/Controller/DBIC/API
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Catalyst/Helper/Controller/DBIC/API
...
PM_TO_BLIB = lib/perl5/i486-linux-gnu-thread-multi/auto/Data/Serializer/.packlist \
	blib/lib/perl5/i486-linux-gnu-thread-multi/auto/Data/Serializer/.packlist \
	REST2.pm \
	$(INST_LIB)/Catalyst/Helper/Controller/DBIC/API/REST2.pm \
	lib/perl5/Data/Serializer.pm \
...
DISTVNAME = Catalyst-Helper-Controller-DBIC-API-REST-0.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  REST2.pm $(INST_MAN3DIR)/Catalyst::Helper::Controller::DBIC::API::REST2.$(MAN3EXT) \
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Catalyst-Controller-DBIC-API" VERSION="1,003000,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Catalyst-Controller-DBIC-API-REST" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  ...
	  REST2.pm $(INST_LIB)/Catalyst/Helper/Controller/DBIC/API/REST2.pm \
